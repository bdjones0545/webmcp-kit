import { type WebMcpRuntimeConfig, type WebMcpTool } from "./runtime.js";
/**
 ...
 */
export declare function useWebMcpTools<TSnapshot>(buildTools: (getSnapshot: () => TSnapshot) => readonly WebMcpTool[], snapshot: TSnapshot, config: WebMcpRuntimeConfig): void;
//# sourceMappingURL=useWebMcp.d.ts.map